...
from ml.entity.data_ingestion_config import(
...
class TrainingPipeline:
    ...
    def start_data_ingestion(self):
        try:
            ...
            data_ingestion=NetworkDataIngestion(data_ingestion_config=self.data_ingestion_config)
    ...
    def start_data_validation(self,data_ingestion_artifact:DataIngestionArtifact):
        try:
            ...
            data_validation=NetworkDataValidation(data_ingestion_artifact=data_ingestion_artifact,data_validation_config=data_validation_config)
